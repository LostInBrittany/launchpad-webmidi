...
export const numbersFromCoords = function ( buttons ) {
...
export const asRow = function ( row, cols ) {
    return cols.map( col => [ row, col ] );
};
export const asCol = function ( col, rows ) {
 ...
 */
export const decodeModifier = function ( modifier ) {
 ...
 */
export const getDecoder = function ( modifier ) {
 ...
 */
export const uniqueCoords = function ( coords ) {
 ...
 */
export const decodeString = function ( pattern ) {
    pattern = pattern || '';
 ...
 * @returns {Array.<Number>}
 */
export const decodeStrings = function ( patterns ) {
